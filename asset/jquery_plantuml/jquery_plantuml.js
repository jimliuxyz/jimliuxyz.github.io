...
function encode64(data) {
 r = "";
 for (i=0; i<data.length; i+="3)" {="" if="" (i+2="=data.length)" r="" +="append3bytes(data.charCodeAt(i)," data.charcodeat(i+1),="" 0);="" }="" else="" (i+1="=data.length)" 0,="" data.charcodeat(i+2));="" return="" r;="" function="" append3bytes(b1,="" b2,="" b3)="" c1="b1">> 2;
c2 = ((b1 & 0x3) << 4) | (b2 >> 4);
c3 = ((b2 & 0xF) << 2) | (b3 >> 6);
c4 = b3 & 0x3F;
r = "";
